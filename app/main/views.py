...
from flask import session, render_template, abort, flash, redirect, url_for, request, current_app, make_response
...
def user(username):
    ...
    posts = pagination.items
    return render_template('users.html', user=user, posts=posts, pagination=pagination)
